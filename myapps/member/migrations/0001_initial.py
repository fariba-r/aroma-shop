    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user', to='member.customuser')),
            ],
            bases=(models.Model, myapps.core.manager.DeleteMixin),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s', to='member.customuser')),
                ('user_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='customuser', to='member.customuser')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='city',
            name='province_id',
            field=models.ForeignKey(on_delete=models.SET('deleted'), related_name='province', to='member.province'),
        ),
        migrations.CreateModel(
            name='Admin',
            fields=[
